...
echo "    2. (Optional, aber empfohlen nach einem Reset) Parameter neu suchen:"
echo "         ./optimize.sh"
echo "       Ohne Strategie-Config (z.B. nach einem Reset) gelten sonst Code-Standardwerte"
echo "       statt der kalibrierten min_confidence/model_max_depth/Anti-Martingale-Werte."
echo "    3. Modell (+ Strategie-Config) committen + pushen:"
echo "         ./push_configs.sh"
echo "    4. Auf dem VPS aktualisieren: ./update.sh"
echo "======================================================="
