...
from oraclebot.analysis.hourly_volatility import load_path_profile
...
if __name__ == '__main__':
    ...
    if notif_cfg.get('telegram_enabled', False):
        ...
        if notif_cfg.get('telegram_send_chart', True):
            ...
            hourly_path_profile_path = os.path.join(artifacts_dir, 'hourly_path_profile.json')
            hourly_path_profile = load_path_profile(hourly_path_profile_path) if os.path.exists(hourly_path_profile_path) else None
            plot_prediction_chart(daily_df, prev_close, atr_value, prediction['trend'], prediction['range'],
                                   ...
                                   target_date, chart_path, hourly_path_profile=hourly_path_profile)
